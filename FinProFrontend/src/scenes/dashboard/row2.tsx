...
const Row2 = () => {
    ...
    console.log("🚀 ~ productExpenseData ~ productExpenseData:", productExpenseData)
    console.log("🚀 ~ Row2 ~ productData:", productData)
        ...
        <>
            ...
            <DashboardBox gridArea="e">
                ...
                <FlexBetween mt="0.25rem" gap="1.5rem" pr="1rem">
                    ...
                    {/* flex basis is a way to set width but for flexbox */}
